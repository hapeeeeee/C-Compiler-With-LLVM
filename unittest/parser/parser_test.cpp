...
TEST(ParserTest, if_stmt) {
    bool res = TestParserWithContent("int main(){int a=0,b=1;if(a>=0){b=100;}else{b=50;}return 0;}",
                                     "int main(){int a=0;int b=1;if(a>=0){b=100;}else{b=50;};return 0;}");
    ASSERT_EQ(res, true);
}

TEST(ParserTest, for_stmt) {
    bool res = TestParserWithContent("int main(){int a=0,b=1;for(int i=0;i<=100;i=i+1){a=a+b;}return 0;}",
                                     "int main(){int a=0;int b=1;for(int i=0;i<=100;i=i+1){a=a+b;};return 0;}");
    ASSERT_EQ(res, true);
}

TEST(ParserTest, break_stmt) {
    bool res = TestParserWithContent("int main(){int a=0,b=1;for(int i=0;i<=100;i=i+1){if(a>20){break;}a=a+b;}return 0;}",
...
TEST(ParserTest, continue_stmt) {
    bool res =
        TestParserWithContent("int main(){int a=0,b=1;for(int i=0;i<=100;i=i+1){if(a==20){continue;}a=a+b;}return 0;}",
...
TEST(ParserTest, assign_op) {
    bool res = TestParserWithContent("int main(){int a;a+=3;a-=3;a*=3;a/=3;a%=3;a|=3;a^=3;a&=3;a<<=3;a>>=3;return a;}",
                                     "int main(){int a;a+=3;a-=3;a*=3;a/=3;a%=3;a|=3;a^=3;a&=3;a<<=3;a>>=3;return a;}");
    ASSERT_EQ(res, true);
}

TEST(ParserTest, unary_op) {
    bool res = TestParserWithContent("int main(){int a=0;int *p=&a;+a;-a;!a;~a;++a;--a;sizeof a;&a;*p;}",
                                     "int main(){int a=0;int *p=&a;+a;-a;!a;~a;++a;--a;sizeof a;&a;*p;}");
    ASSERT_EQ(res, true);
}
...
TEST(ParserTest, post_op) {
    bool res = TestParserWithContent("int main(){int a=3;int *p=&a;p++;p--;*p++;*p--;++*p;--*p;}",
                                     "int main(){int a=3;int *p=&a;p++;p--;*p++;*p--;++*p;--*p;}");
    ASSERT_EQ(res, true);
}

TEST(ParserTest, multi_point_op) {
    bool res =
        TestParserWithContent("int main(){int a=3;int *p=&a;int **q=&p;--*p;}", "int main(){int a=3;int *p=&a;int **q=&p;--*p;}");
    ASSERT_EQ(res, true);
}

TEST(ParserTest, sizeof_op) {
    bool res = TestParserWithContent("int main(){int a=3;sizeof a;sizeof (a);sizeof(int);}",
                                     "int main(){int a=3;sizeof a;sizeof a;sizeof (int );}");
    ASSERT_EQ(res, true);
}
