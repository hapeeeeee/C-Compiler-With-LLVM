...
mergeBB:                                          ; preds = %falseBB, %nextBB
  ...
  %a212 = load i32, ptr %a2, align 4
  %3 = icmp ne i32 %a212, 0
...
mergeBB13:                                        ; preds = %nextBB11, %trueBB
  ...
  %b827 = load i32, ptr %b8, align 4
  %b728 = load i32, ptr %b7, align 4
  %11 = add nsw i32 %b827, %b728
  %b629 = load i32, ptr %b6, align 4
  %12 = add nsw i32 %11, %b629
  %b530 = load i32, ptr %b5, align 4
  %13 = add nsw i32 %12, %b530
  %b431 = load i32, ptr %b4, align 4
  %14 = add nsw i32 %13, %b431
  %b332 = load i32, ptr %b3, align 4
  %15 = add nsw i32 %14, %b332
  %b233 = load i32, ptr %b2, align 4
  %16 = add nsw i32 %15, %b233
  %b134 = load i32, ptr %b1, align 4
  %17 = add nsw i32 %16, %b134
